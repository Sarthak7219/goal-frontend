...
import GalleryShimmer from "./GalleryShimmer"; // Import the shimmer component
            ...
            <section id="visit-pics" className="gallery">
              ...
              <div className="page-number-wrapper">
                {pagesVisit.map((page, index) => (
                  <button key={index} onClick={() => setCurrentVisitPage(page)}>
                    {page}
                  </button>
                ))}
              </div>
            ...
            <section id="workshop-pics" className="gallery">
              ...
              <div className="page-number-wrapper">
                {pagesWorkshop.map((page, index) => (
                  <button key={index} onClick={() => setCurrentWorkshopPage(page)}>
                    {page}
                  </button>
                ))}
              </div>
